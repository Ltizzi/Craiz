  ...
  <div class="flex w-full flex-row gap-2 bg-slate-700 py-3" v-if="props.back">
    ...
    <div class="flex w-10/12 items-center justify-center">
      <input
        ...
        class="relative w-11/12 rounded-2xl bg-slate-600 px-2 py-1 pl-5 text-white"
        v-model="inputSearch"
        id="inputBar"
      ...
      <font-awesome-icon
        ...
        class="absolute right-16 rounded-r-full bg-slate-500 py-2 pl-2 pr-3 text-gray-300 hover:cursor-pointer"
  ...
  <div class="flex w-full flex-row gap-2 bg-slate-700 py-3" v-else>
    <div class="flex items-center justify-center">
      <input
        type="text"
        placeholder="Buscar en Craze"
        class="relative rounded-2xl bg-slate-600 px-2 py-1 pl-5 text-white"
        v-model="inputSearch"
        id="inputBar"
        @keyup.enter="handleEnterEvent"
        @keypress="isSearching"
